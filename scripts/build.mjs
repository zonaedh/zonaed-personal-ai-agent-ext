...
console.log('== 4/4 copy public assets & root web entry ==');
...
// Generate root index.html for Vercel Web Portal
const sidepanelHtml = join(distDir, 'src', 'sidepanel', 'index.html');
const rootHtml = join(distDir, 'index.html');
if (existsSync(sidepanelHtml)) {
  cpSync(sidepanelHtml, rootHtml, { force: true });
}
